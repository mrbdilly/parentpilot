...
// Complete activity database - 74 activities
const activities = [
  // 12-18 MONTHS - HOME - LOW ENERGY
  ...
  // 12-18 MONTHS - HOME - MEDIUM ENERGY
  ...
  // 12-18 MONTHS - OUT & ABOUT - LOW ENERGY
  ...
  // 12-18 MONTHS - OUT & ABOUT - MEDIUM ENERGY
  ...
  // 12-18 MONTHS - OUT & ABOUT - HIGH ENERGY
  ...
  // 18-24 MONTHS - HOME - MEDIUM ENERGY
  ...
  // 18-24 MONTHS - OUT & ABOUT - LOW ENERGY
  ...
  // 18-24 MONTHS - OUT & ABOUT - MEDIUM ENERGY
  ...
  // 18-24 MONTHS - OUT & ABOUT - HIGH ENERGY
  ...
  // 2-3 YEARS - OUT & ABOUT - LOW ENERGY
  ...
  // 2-3 YEARS - OUT & ABOUT - MEDIUM ENERGY
  ...
  // 2-3 YEARS - OUT & ABOUT - HIGH ENERGY
...
export default function ParentPilot() {
  ...
  const findActivities = () => {
    let filtered = activities.filter(activity => {
      ...
      const energyMatch = activity.energy === energy || 
                         (energy === 'high' && activity.energy === 'medium');
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-6xl font-black text-gray-900">ParentPilot</h1>
            </div>
          ...
          {suggestions.length === 0 ? (
            ...
            suggestions.map((activity) => (
              <div key={activity.id} className="bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-shadow">
                ...
                <p className="text-gray-700 text-lg mb-5 leading-relaxed font-medium">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-5 mb-5">
                  ...
                  <p className="text-gray-600 font-medium">{activity.materials}</p>
                </div>
